...
class ProductQuantizationTest(testutil.BaseFacebookTestCase):
    def setUp(self) -> None:
        super().setUp()

    def test_em_constant(self) -> None:
        """
    ...
    def test_em_error(self) -> None:
        ...
        self.assertRaises(EmptyClusterResolveError, em.learn)

    def test_pq_linear_constant(self) -> None:
        """
    ...
    def test_pq_conv_constant(self) -> None:
        """
    ...
    def test_pq_many_dicts(self) -> None:
        """
        ...
        true_centroids = torch.stack(
            [seed, seed, 2 * seed, 2 * seed, 3 * seed, 3 * seed]
        )
        norm = (centroids.sort(dim=0).values - true_centroids).norm()
    ...
    def test_pq_conv_block_size(self) -> None:
        """
        ...
        self.assertEqual(centroids.size(1), kernel_size * kernel_size)

    def test_pq_linear_n_centroids(self) -> None:
        """
        ...
        self.assertEqual(n_centroids, 16)
