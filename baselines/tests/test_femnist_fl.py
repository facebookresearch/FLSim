...
from flsim.baselines.run_femnist_fl import train
...
CONFIG_PATH = "configs"
CONFIG_NAME = "test_femnist_fl"


class TestFEMNISTFL(testutil.BaseFacebookTestCase):
    def test_femnist_fl_training_with_json_config(self) -> None:
    ...
    def test_femnist_fl_training_with_yaml_config(self) -> None:
