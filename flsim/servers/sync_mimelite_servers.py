...
class SyncMimeLiteServer(SyncServer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        init_self_cfg(
            ...
            config_class=SyncMimeLiteServerConfig,
            **kwargs,
        )
        ...
        # MIMELite Specific changes here
        ...
        # MIMELite uses a vanilla SGD optimizer to update the parameters of the global model
    ...
    def broadcast_message_to_clients(
        ...
        assert (
            num_examples > 0
        ), "All selected clients in the current round have no data"
